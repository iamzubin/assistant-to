...
- `mail_check`: recipient="builder-1"
...
**Debug:** `buffer_capture` (agent_id="builder-1", lines)

**Logging:** `log_event` (agent_id="builder-1", type, details)

## Autonomy Protocol
1. **Start**: Log "Starting task 1", mail plan
...
**Title:** Expand task info in dashboard

**Description:**
Expand the task information displayed in the dashboard to show more details about each task
