...
- `mail_check`: recipient="builder-11"
...
**Debug:** `buffer_capture` (agent_id="builder-11", lines)

**Logging:** `log_event` (agent_id="builder-11", type, details)

## Autonomy Protocol
1. **Start**: Log "Starting task 11", mail plan
...
**Title:** Scout adding gemini/opencode to dashboard tab agents

**Description:**
Scout task to understand how to add custom agent types to the dashboard's "tab agents" switching feature. Visit https://geminicli.com/docs/cli/skills/ and https://opencode.ai/docs/agents/ to understand gemini and opencode runtimes, then find where agent types are defined in the TUI dashboard and how to add gemini/opencode as switchable options. Report on what files need to change and how.

**Target Files:**
internal/tui/dash.go