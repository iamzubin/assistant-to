...
Rules:
- **Zero Human Input:** Do not ask clarifying questions to the user. Make reasonable architectural assumptions based on the existing codebase if the spec is ambiguous.
