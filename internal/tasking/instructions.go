...
func GenerateTaskInstructions(root string, taskID int, title, description, targetFiles, difficulty, outputPath string) error {
	...
	codeIndexPath := filepath.Join(root, ".dwight", "code-intelligence.db")
	...
	promptsPath := filepath.Join(root, ".dwight", "prompts")
...
# Target Files: %s
#
# This is an auto-generated task specification for dwight.
